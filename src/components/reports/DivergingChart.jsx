...
import rawData from "../../assets/data/activities.json";
        ...
        >
          <button
            ...
            style={{
              ...
              borderRadius: "8px",
              cursor: "pointer",
              fontFamily: "'Tajawal', sans-serif", // أضف هذا السطر هنا
              fontSize: "14px",
              fontWeight: "bold",
              transition: "all 0.2s ease",
              backgroundColor: metric === "absolute" ? "#fff" : "transparent",
              color: metric === "absolute" ? "#2c3e50" : "#777",
              boxShadow:
                metric === "absolute" ? "0 2px 8px rgba(0,0,0,0.15)" : "none",
            }}
          >
            الفرق المطلق
          </button>
          ...
          <button
            ...
            style={{
              ...
              color: metric === "relative" ? "#2c3e50" : "#777",
              boxShadow:
                metric === "relative" ? "0 2px 8px rgba(0,0,0,0.15)" : "none",
            }}
          >
            الفرق النسبي
          </button>
